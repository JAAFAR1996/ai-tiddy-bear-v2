...
if __name__ == "__main__":
    ...
    async def main():
        ...
        try:
            ...
            # validator = StartupValidator(settings=settings) # Uncomment and adjust if Settings needs to be passed to validator
            validator = StartupValidator() # Directly instantiate without Settings dependency
