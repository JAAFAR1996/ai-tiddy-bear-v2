...
from src.infrastructure.health.models import HealthStatus, SystemHealth, HealthCheckResult
...
class HealthCheckManager:
    ...
    async def check_health(self, detailed: bool = False) -> SystemHealth:
        ...
        async with self._cache_lock:
            ...
            if (self._cached_result and self._last_check_time and
                (datetime.utcnow() - self._last_check_time).total_seconds() < self._cache_duration):
        ...
        summary = {
            ...
            "healthy_checks": sum(1 for c in health_checks if c.status == HealthStatus.HEALTHY),
...
def get_health_manager(config: Optional[Dict[str, Any]] = None) -> HealthCheckManager:
