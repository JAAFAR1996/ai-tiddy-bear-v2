...
class TestCreateApp:
    ...
    def test_create_app_returns_fastapi_instance(self):
        ...
        with (patch('main._setup_app_configurations'),
    ...
    def test_create_app_calls_all_setup_functions(self):
        ...
        with (patch('main._setup_app_configurations') as mock_config,
...
class TestLifespanEvents:
    ...
    async def test_lifespan_startup_validation_success(self):
        ...
        with (patch.dict(os.environ, {'REDIS_URL': 'redis://localhost:6379/0'}),
              ...
              patch('main.get_rate_limiter'),
              patch('main.Database') as mock_db_class,
              patch('src.infrastructure.validators.config.startup_validator.StartupValidator') as mock_validator_class,
              patch('src.infrastructure.validators.config.startup_validator.validate_startup') as mock_validate):
...
class TestSetupAppConfigurations:
    ...
    def test_setup_app_configurations_calls_production_safety(self):
        ...
        with (patch('main.enforce_production_safety') as mock_safety,
              patch('main.container.settings') as mock_settings,
    ...
    def test_setup_app_configurations_configures_logging(self):
        ...
        with (patch('main.enforce_production_safety'),
              patch('main.container.settings') as mock_settings,
...
class TestValidateSystemStartup:
    ...
    def test_validate_system_startup_runtime_error(self):
        ...
        with patch('main.container.wire') as mock_wire:
            ...
            with pytest.raises(StartupValidationException,
...
class TestSetupAppMiddlewaresAndRoutes:
    ...
    def test_setup_middlewares_and_routes_calls_all_functions(self):
        ...
        with (patch('main.setup_middleware') as mock_middleware,
...
class TestIntegrationScenarios:
    ...
    def test_error_handling_chain(self):
        ...
        # Configuration error
        with (patch('main.enforce_production_safety', side_effect=Exception("Safety check failed")),
              pytest.raises(Exception, match="Safety check failed")):
            _setup_app_configurations()

        # Validation error
        with (patch('main.container.wire', side_effect=RuntimeError("Wiring failed")),
