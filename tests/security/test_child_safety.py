...
class TestContentModerator:
    ...
    def custom_moderator(self):
        ...
        custom_patterns = {
            "test_category": [r"\b(test_unsafe_word)\b"]
        }
    ...
    def test_init_custom_patterns(self, custom_moderator):
        ...
        assert "violence" in custom_moderator.UNSAFE_PATTERNS  # Should still have defaults
    ...
    @pytest.mark.parametrize("content,age,expected", [
        ("I want to kill the monster", 5, False),  # Violence for young child
        ("Let's fight the dragon", 10, True),  # Acceptable fantasy for older child
        ...
        ("That's scary like a ghost", 4, False),  # Scary content for young child
    ...
    @pytest.mark.parametrize("age,max_violence,max_scary", [
        (3, 0, 0),
        (5, 0, 1),
        (8, 1, 2),
        (12, 2, 3),
...
class TestChildEntity:
    ...
    def test_invalid_age_too_young(self, age):
        ...
        with pytest.raises(ValueError, match="Children under 2 years are not supported"):
...
class TestContentCategory:
    ...
    def test_content_categories(self):
        ...
        expected_categories = [
            "educational", "entertainment", "story", "game", 
            "conversation", "social", "personal", "neutral", "inappropriate"
        ]
...
class TestSafetyIntegration:
    ...
    @pytest.mark.parametrize("age,message,expected_safe", [
    ...
    def test_safety_audit_logging(self):
        ...
        with patch('src.domain.safety.models.logger') as mock_logger:
            ...
            assert mock_logger.called or True  # Placeholder for actual logging verification
