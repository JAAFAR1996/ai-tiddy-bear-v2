...
class TestSecurity:
    ...
    def test_injection_prevention(self):
        ...
        for malicious_input in malicious_inputs:
            ...
            response = self.ai_service.generate_response(
                malicious_input, 6, {"language": "en"}
            )

            # التأكد من أن الاستجابة آمنة
            assert response["safety_analysis"]["safe"] in [
                True,
                False,
            ]  # يجب أن يتم تحليلها
    ...
    def test_data_sanitization(self):
        ...
        harmful_inputs = ["stupid kid", "I hate you", "shut up now"]
    ...
    def test_age_verification(self):
        ...
        for age in ages:
            ...
            if age < 8:
                ...
                assert (
                    "friend" in response["response"].lower()
                    or "play" in response["response"].lower()
                )
