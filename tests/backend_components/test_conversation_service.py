...
class TestConversationService:
    ...
    async def test_conversation_flow(self, conversation_service):
        ...
        conversation_service.start_conversation = AsyncMock(return_value=Conversation(
            id="conv123",
            child_id="child456",
        ...
        conversation_service.end_conversation = AsyncMock(return_value=Conversation(
            id="conv123",
            child_id="child456",
        ...
        ended_conversation = await conversation_service.end_conversation("conv123", "محادثة ودية مع طلب قصة", "positive", 0.8)
    ...
    async def test_conversation_analysis(self, conversation_service):
        ...
        # Setup
        conversation_service.analyze_conversation = AsyncMock(return_value={
