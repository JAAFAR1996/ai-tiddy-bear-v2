...
class TestAuditDecorators:
    ...
    def mock_audit_integration(self):
        ...
        with patch('src.infrastructure.security.audit_decorators.get_audit_integration', return_value=mock_integration):
    ...
    def test_audit_authentication_decorator_async_success(self, mock_audit_integration, mock_datetime):
        ...
        result = asyncio.run(test_login("user@example.com", "password", ip_address="192.168.1.100"))
    ...
    def test_audit_authentication_decorator_async_failure(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_authentication_decorator_sync_success(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_authentication_custom_extractors(self, mock_audit_integration, mock_datetime):
        ...
        @audit_authentication("password_change", extract_email=extract_email, extract_ip=extract_ip)
    ...
    def test_audit_data_access_decorator_async_success(self, mock_audit_integration, mock_datetime):
        ...
        result = asyncio.run(get_child_profile("user_123", "child_456", ip_address="192.168.1.200"))
    ...
    def test_audit_data_access_decorator_async_failure(self, mock_audit_integration, mock_datetime):
        ...
        with pytest.raises(PermissionError, match="Access denied"):
            asyncio.run(update_child_profile("user_123", "child_456", {"name": "New Name"}))
    ...
    def test_audit_data_access_missing_required_params(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_data_access_custom_extractors(self, mock_audit_integration, mock_datetime):
        ...
        @audit_data_access("create", "child_profile", extract_child_id, extract_user_id, extract_ip)
        ...
        result = asyncio.run(create_child_profile(profile_data, auth_context, request_meta))
    ...
    def test_audit_security_event_decorator_async_success(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_security_event_decorator_async_failure(self, mock_audit_integration, mock_datetime):
        ...
        with pytest.raises(NameError):  # SecurityError is not defined, will raise NameError
            asyncio.run(check_access_violation("user_suspicious"))
        
        # Verify audit logging was called with error severity
        call_args = mock_audit_integration.log_security_event.call_args[1]
        assert call_args["severity"] == "error"  # Should override to error on failure
        assert "Error:" in call_args["description"]
    
    def test_audit_security_event_sync_function(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_login_convenience_decorator(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_logout_convenience_decorator(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_child_create_convenience_decorator(self, mock_audit_integration, mock_datetime):
        ...
        result = asyncio.run(create_child("parent_123", "child_789", {"name": "New Child"}))
    ...
    def test_audit_child_update_convenience_decorator(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_child_delete_convenience_decorator(self, mock_audit_integration, mock_datetime):
    ...
    def test_decorator_handles_audit_integration_error(self, mock_datetime):
        ...
        with patch('src.infrastructure.security.audit_decorators.get_audit_integration', side_effect=Exception("Audit error")):
            with patch('src.infrastructure.security.audit_decorators.logger') as mock_logger:
                @audit_authentication("login")
    ...
    def test_argument_extraction_edge_cases(self, mock_audit_integration, mock_datetime):
    ...
    def test_argument_extraction_from_object_attributes(self, mock_audit_integration, mock_datetime):
    ...
    def test_audit_data_access_fallback_extraction(self, mock_audit_integration, mock_datetime):
    ...
    def test_decorator_timing_measurement(self, mock_audit_integration):
        ...
        assert duration_ms < 200   # But not too much more (allowing for test overhead)
    
    def test_multiple_decorators_on_same_function(self, mock_audit_integration, mock_datetime):
    ...
    def test_decorator_with_complex_function_signature(self, mock_audit_integration, mock_datetime):
        ...
        result = asyncio.run(complex_function(
            None,  # self
            "arg1", "arg2",  # *args
    ...
    def test_decorator_error_handling_in_sync_mode(self, mock_audit_integration, mock_datetime):
    ...
    def test_decorator_audit_scheduling_error_handling(self, mock_audit_integration, mock_datetime):
