...
class TestTokenService:
    ...
    def mock_settings(self):
        ...
        settings.security.SECRET_KEY = "test_secret_key_that_is_longer_than_32_characters_for_security"
    ...
    def token_service(self, mock_settings):
        ...
        with patch('src.infrastructure.security.token_service.get_settings', return_value=mock_settings):
    ...
    def test_token_service_initialization(self, token_service, mock_settings):
        ...
        assert token_service.access_token_expire_minutes == mock_settings.security.ACCESS_TOKEN_EXPIRE_MINUTES
        assert token_service.refresh_token_expire_days == mock_settings.security.REFRESH_TOKEN_EXPIRE_DAYS
    ...
    def test_create_access_token_valid_user(self, token_service, sample_user_data):
        ...
        with patch('src.infrastructure.security.token_service.jwt.encode') as mock_encode:
    ...
    def test_create_access_token_valid_child(self, token_service, sample_child_user_data):
    ...
    def test_create_access_token_expiration_time(self, token_service, sample_user_data):
        ...
        with patch('src.infrastructure.security.token_service.jwt.encode') as mock_encode:
            with patch('src.infrastructure.security.token_service.datetime') as mock_datetime:
    ...
    def test_create_refresh_token_valid_child(self, token_service, sample_child_user_data):
    ...
    def test_create_refresh_token_expiration_time(self, token_service, sample_user_data):
    ...
    async def test_verify_token_valid_token(self, token_service):
        ...
        with patch('src.infrastructure.security.token_service.jwt.decode') as mock_decode:
...
class TestTokenServiceIntegration:
    ...
    def test_token_creation_and_verification_flow(self, token_service, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_roundtrip_verification(self, token_service, sample_user_data):
    ...
    def test_token_service_with_different_expiration_times(self, mock_settings, sample_user_data):
    ...
    def test_token_service_security_best_practices(self, token_service, sample_user_data):
    ...
    def test_token_service_performance_characteristics(self, token_service, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_token_service_concurrent_operations(self, token_service, sample_user_data):
