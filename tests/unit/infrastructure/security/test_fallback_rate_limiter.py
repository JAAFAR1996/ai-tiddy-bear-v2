...
class TestSlidingWindowRateLimiter:
    ...
    async def test_is_allowed_within_limit(self, rate_limiter):
        ...
        for i in range(3):
            ...
            assert result["remaining"] == 5 - (i + 1) - 1  # remaining after this request
    ...
    async def test_thread_safety(self, rate_limiter):
        ...
        # At least some should be allowed, and likely some blocked due to rate limiting
...
class TestFallbackRateLimitService:
    ...
    def test_initialization_with_redis(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_check_redis_availability_client_success(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_check_redis_availability_client_failure(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_check_redis_availability_caching(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_is_allowed_with_redis_unavailable(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_redis_rate_limit_fallback(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_get_statistics_with_redis(self, fallback_service_with_redis, mock_redis_client):
    ...
    def test_set_custom_limit(self, fallback_service):
        ...
        assert fallback_service.fallback_limiter._custom_limits[key] == (limit, window_seconds)
    ...
    @pytest.mark.asyncio
    async def test_reset_user_limits_with_redis(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_reset_user_limits_redis_error(self, fallback_service_with_redis, mock_redis_client):
    ...
    @pytest.mark.asyncio
    async def test_redis_availability_state_changes(self, fallback_service_with_redis, mock_redis_client):
    ...
    async def test_concurrent_rate_limiting(self, fallback_service):
        ...
        tasks = [
            fallback_service.is_allowed(user_id)
    ...
    @pytest.mark.asyncio
    async def test_service_degradation_graceful(self, fallback_service_with_redis, mock_redis_client):
