...
class TestCOPPAComplianceLevel:
    ...
    def test_coppa_compliance_level_coverage(self):
        ...
        expected_levels = ["under_coppa", "coppa_transition", "general_protection"]
...
class TestCOPPAValidator:
    ...
    def mock_coppa_enabled(self):
        ...
        with patch('src.infrastructure.security.coppa_validator.is_coppa_enabled') as mock:
    ...
    @pytest.mark.parametrize("age,expected_coppa_subject", [
        (3, True),
        (7, True),
        (12, True),
        (13, False),
    ...
    def test_validate_age_compliance_coppa_enabled(self, validator, mock_coppa_enabled, age, expected_coppa_subject):
    ...
    def test_validate_age_compliance_coppa_disabled(self, validator, mock_coppa_disabled, age):
    ...
    def test_validate_age_compliance_transition_age(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_compliance_general_protection(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_compliance_invalid_type(self, validator, mock_coppa_enabled, invalid_age):
    ...
    def test_validate_age_compliance_too_young(self, validator, mock_coppa_enabled, invalid_age):
        """Test age validation for ages too young."""
        with pytest.raises(ValueError, match="is below minimum allowed age"):
            validator.validate_age_compliance(invalid_age)
    
    def test_validate_age_compliance_too_old_strict(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_compliance_too_old_not_strict(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_compliance_coppa_disabled_age_limits(self, validator, mock_coppa_disabled):
    ...
    def test_is_coppa_subject_enabled(self, validator, mock_coppa_enabled, age, expected):
        """Test is_coppa_subject method when COPPA is enabled."""
        result = validator.is_coppa_subject(age)
        assert result == expected
    
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_is_coppa_subject_disabled(self, validator, mock_coppa_disabled, age):
    ...
    def test_get_data_retention_period_enabled(self, validator, mock_coppa_enabled, age, expected_days):
    ...
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_get_data_retention_period_disabled(self, validator, mock_coppa_disabled, age):
        """Test data retention period when COPPA is disabled."""
        result = validator.get_data_retention_period(age)
        assert result == 365 * 2  # 2 years when COPPA disabled
    
    def test_get_data_retention_period_invalid_age(self, validator, mock_coppa_enabled):
    ...
    def test_requires_parental_consent_enabled(self, validator, mock_coppa_enabled, age, expected):
        """Test parental consent requirement when COPPA is enabled."""
        result = validator.requires_parental_consent(age)
        assert result == expected
    
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_requires_parental_consent_disabled(self, validator, mock_coppa_disabled, age):
    ...
    def test_validate_age_range_with_params(self, validator, mock_coppa_enabled, age, min_age, max_age, expected):
        """Test age range validation with custom parameters."""
        result = validator.validate_age_range(age, min_age, max_age)
        assert result == expected
    
    def test_validate_age_range_default_params(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_range_invalid_type(self, validator, mock_coppa_enabled):
    ...
    def test_validate_age_range_validation_exception(self, validator, mock_coppa_enabled):
        """Test age range validation handles validation exceptions."""
        with patch.object(validator, 'validate_age_compliance', side_effect=ValueError("Test error")):
...
class TestCOPPAValidatorGlobalFunctions:
    ...
    def test_is_coppa_subject_function_enabled(self, mock_coppa_enabled, age, expected):
        """Test global is_coppa_subject function when COPPA is enabled."""
        result = is_coppa_subject(age)
        assert result == expected
    
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_is_coppa_subject_function_disabled(self, mock_coppa_disabled, age):
    ...
    def test_requires_parental_consent_function_enabled(self, mock_coppa_enabled, age, expected):
        """Test global requires_parental_consent function when COPPA is enabled."""
        result = requires_parental_consent(age)
        assert result == expected
    
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_requires_parental_consent_function_disabled(self, mock_coppa_disabled, age):
    ...
    def test_get_data_retention_days_function_enabled(self, mock_coppa_enabled, age, expected_days):
        """Test global get_data_retention_days function when COPPA is enabled."""
        result = get_data_retention_days(age)
        assert result == expected_days
    
    @pytest.mark.parametrize("age", [3, 7, 12, 13, 15, 16])
    def test_get_data_retention_days_function_disabled(self, mock_coppa_disabled, age):
...
class TestCOPPAValidatorEdgeCases:
    ...
    def test_special_protections_structure(self, validator, mock_coppa_enabled):
        ...
        assert all(isinstance(v, bool) for v in result.special_protections.values())
    ...
    def test_data_retention_error_handling(self, validator, mock_coppa_enabled):
    ...
    def test_validation_result_type_consistency(self, validator, mock_coppa_enabled):
    ...
    def test_age_validation_with_config_mock(self, validator):
        ...
        with patch('src.infrastructure.security.coppa_validator.is_coppa_enabled') as mock_enabled:
