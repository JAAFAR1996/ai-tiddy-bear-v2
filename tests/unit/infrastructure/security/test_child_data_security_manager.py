...
from src.infrastructure.security.child_data_security_manager import ChildDataSecurityManager
...
class MockCOPPAComplianceRecord:
    def __init__(self, **kwargs):
        ...
        self.data_retention_expires = kwargs.get('data_retention_expires', datetime.utcnow() + timedelta(days=90))
...
class TestChildDataSecurityManager:
    ...
    def mock_encryption_service(self):
        ...
        with patch('src.infrastructure.security.child_data_security_manager.ChildDataEncryption') as mock_class:
            mock_service = Mock()
    ...
    def mock_coppa_service(self):
        ...
        with patch('src.infrastructure.security.child_data_security_manager.COPPAComplianceService') as mock_class:
            mock_service = Mock()
            mock_class.return_value = mock_service
    ...
    def test_initialization_with_key(self, mock_encryption_service, mock_coppa_service):
    ...
    def test_initialization_without_key(self, mock_encryption_service, mock_coppa_service):
    ...
    def test_secure_child_profile_success(self, security_manager, mock_encryption_service, mock_coppa_service):
        ...
        security_manager.encryption.create_consent_record.return_value = mock_consent_record
        ...
        security_manager.encryption.validate_coppa_compliance.return_value = compliance_check
        ...
        security_manager.encryption.encrypt_child_data.assert_called_once_with(child_data)
    ...
    def test_secure_child_profile_missing_consent_fields(self, security_manager):
    ...
    def test_secure_child_profile_error_handling(self, security_manager):
        ...
        security_manager.encryption.create_consent_record.side_effect = Exception("Encryption error")
    ...
    def test_secure_child_profile_logging_on_error(self, security_manager):
        ...
        security_manager.encryption.create_consent_record.side_effect = Exception(error_message)
        
        with patch('src.infrastructure.security.child_data_security_manager.logger') as mock_logger:
    ...
    def test_get_child_data_for_interaction_success(self, security_manager):
        ...
        encrypted_child_data = {
            ...
            "_coppa_compliance": {
                ...
                "data_retention_expires": (datetime.utcnow() + timedelta(days=30)).isoformat(),
        ...
        result = security_manager.get_child_data_for_interaction(encrypted_child_data)
        
        # Verify decryption was called
        security_manager.encryption.decrypt_child_data.assert_called_once_with(encrypted_child_data)
    ...
    def test_get_child_data_for_interaction_expired_retention(self, security_manager):
        ...
        with pytest.raises(ValueError, match="Child data retention period expired"):
            security_manager.get_child_data_for_interaction(encrypted_child_data)
        
        # Should not attempt decryption for expired data
        security_manager.encryption.decrypt_child_data.assert_not_called()
    
    def test_get_child_data_for_interaction_no_coppa_info(self, security_manager):
    ...
    def test_get_child_data_for_interaction_error_handling(self, security_manager):
        ...
        security_manager.encryption.decrypt_child_data.side_effect = Exception("Decryption error")
        
        with pytest.raises(Exception, match="Decryption error"):
            security_manager.get_child_data_for_interaction(encrypted_child_data)
    
    def test_get_child_data_for_interaction_logging_on_error(self, security_manager):
        ...
        security_manager.encryption.decrypt_child_data.side_effect = Exception(error_message)
    ...
    def test_schedule_data_cleanup_no_expired_records(self, security_manager):
        ...
        with patch('src.infrastructure.security.child_data_security_manager.datetime') as mock_dt:
    ...
    def test_schedule_data_cleanup_with_expired_records(self, security_manager):
        ...
        security_manager.coppa_service.check_data_retention_compliance.return_value = expired_records
    ...
    def test_schedule_data_cleanup_no_logging_when_no_expired(self, security_manager):
    ...
    def test_comprehensive_workflow(self, security_manager):
        ...
        compliance_check = {"compliant": True, "violations": [], "warnings": [], "required_actions": []}
        security_manager.encryption.validate_coppa_compliance.return_value = compliance_check
        ...
        secured_profile = security_manager.secure_child_profile(child_data, parent_consent)
        ...
        security_manager.encryption.decrypt_child_data.return_value = decrypted_for_interaction
        
        interaction_data = security_manager.get_child_data_for_interaction(secured_profile)
    ...
    def test_service_integration_with_different_consent_methods(self, security_manager):
    ...
    def test_edge_cases_datetime_handling(self, security_manager):
        ...
        for dt_str in datetime_formats:
            ...
            try:
                ...
                assert "time data" in str(e) or "does not match format" in str(e)
    ...
    def test_memory_efficiency_large_datasets(self, security_manager):
        ...
        result = security_manager.secure_child_profile(large_child_data, parent_consent)
