...
class TestCOPPAComplianceService:
    ...
    def test_process_parental_consent_success(self, coppa_service, mock_encryption_service):
    ...
    def test_process_parental_consent_different_methods(self, coppa_service, mock_encryption_service):
    ...
    def test_process_parental_consent_error_handling(self, coppa_service, mock_encryption_service):
        ...
        mock_encryption_service.create_consent_record.side_effect = Exception("Encryption service error")
    ...
    def test_process_parental_consent_logging_on_error(self, coppa_service, mock_encryption_service):
        ...
        mock_encryption_service.create_consent_record.side_effect = Exception(error_message)
        
        with patch('src.infrastructure.security.coppa_compliance_service.logger') as mock_logger:
            result = coppa_service.process_parental_consent(
                child_id, parent_email, consent_method, ip_address
            )
    ...
    def test_check_data_retention_compliance_no_expired_records(self, coppa_service, mock_encryption_service):
        ...
        for child_id, expiry_date in active_records:
            mock_record = MockCOPPAComplianceRecord(
                child_id=child_id,
                data_retention_expires=expiry_date
            )
    ...
    def test_check_data_retention_compliance_with_expired_records(self, coppa_service, mock_encryption_service):
    ...
    def test_check_data_retention_compliance_formatting(self, coppa_service, mock_encryption_service):
    ...
    def test_multiple_consent_records_management(self, coppa_service, mock_encryption_service):
        """Test management of multiple consent records."""
        children_data = [
            ("child_1", "parent1@email.com", "email_verification", "192.168.1.1"),
            ("child_2", "parent2@email.com", "sms_verification", "192.168.1.2"),
    ...
    def test_compliance_service_with_edge_case_data(self, coppa_service, mock_encryption_service):
        ...
        for i, case in enumerate(edge_cases):
            ...
            try:
                ...
                # If encryption service rejects edge case, should handle gracefully
