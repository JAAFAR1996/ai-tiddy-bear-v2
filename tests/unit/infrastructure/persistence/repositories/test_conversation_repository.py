...
class TestConversationRepositoryCreate:
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_success(self, conversation_repository, mock_database, 
        ...
        with patch('src.infrastructure.persistence.repositories.conversation_repository.validate_database_operation',
                  return_value={"data": sample_conversation_data}):
            # Act
            conversation_id = await conversation_repository.create_conversation(**sample_conversation_data)
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_empty_message(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_security_violation(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_database_error(self, conversation_repository, mock_database,
                                                    sample_conversation_data):
        ...
        with patch('src.infrastructure.persistence.repositories.conversation_repository.validate_database_operation',
            ...
            with pytest.raises(RuntimeError, match="Database error"):
                await conversation_repository.create_conversation(**sample_conversation_data)
...
class TestConversationRepositoryHistory:
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_history_success(self, conversation_repository, mock_database):
        ...
        # Act
        result = await conversation_repository.get_conversation_history(child_id, limit=5)
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_history_with_limit(self, conversation_repository, mock_database):
        ...
        # Act
        result = await conversation_repository.get_conversation_history(child_id, limit=20)
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_history_invalid_limit(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_history_database_error(self, conversation_repository, mock_database):
...
class TestConversationRepositoryCount:
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_count_success(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_count_no_conversations(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_count_invalid_hours(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_count_database_error(self, conversation_repository, mock_database):
...
class TestConversationRepositoryDeletion:
    ...
    @pytest.mark.asyncio
    async def test_delete_old_conversations_success(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_delete_old_conversations_none_found(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_delete_old_conversations_invalid_days(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_delete_old_conversations_database_error(self, conversation_repository, mock_database):
        """Test deletion with database error."""
        # Arrange
        mock_session = AsyncMock()
        mock_session.execute.side_effect = Exception("Cannot delete: foreign key constraint")
...
class TestConversationRepositoryEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_very_long_message(self, conversation_repository, mock_database):
    ...
    @pytest.mark.asyncio
    async def test_get_conversation_history_with_metadata(self, conversation_repository, mock_database):
        ...
        # Act
        result = await conversation_repository.get_conversation_history(child_id, limit=1)
