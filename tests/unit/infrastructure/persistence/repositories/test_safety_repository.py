...
class TestSafetyEventRecording:
    ...
    async def test_record_safety_event_success(self, safety_repository, mock_database):
        ...
        with patch(
            "src.infrastructure.persistence.repositories.safety_repository.validate_database_operation",
            return_value={
                "data": {
                    "child_id": child_id,
    ...
    @pytest.mark.asyncio
    async def test_record_safety_event_default_severity(
    ...
    @pytest.mark.asyncio
    async def test_record_safety_event_critical_severity(
        self, safety_repository, mock_database
    ):
    ...
    @pytest.mark.asyncio
    async def test_record_safety_event_security_violation(
        self, safety_repository, mock_database
    ):
    ...
    @pytest.mark.asyncio
    async def test_record_safety_event_database_error(
        self, safety_repository, mock_database
    ):
...
class TestSafetyScoreUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_safety_score_boundary_values(
        self, safety_repository, mock_database
    ):
        ...
        with patch(
            ...
            result = await safety_repository.update_safety_score(
                child_id, 0.0, "Critical safety concern"
            )
            assert result is True
        ...
        with patch(
            ...
            result = await safety_repository.update_safety_score(
                child_id, 1.0, "Perfect safety record"
            )
            assert result is True

    @pytest.mark.asyncio
    async def test_update_safety_score_invalid_range(
        self, safety_repository, mock_database
    ):
...
class TestSafetyEventRetrieval:
    ...
    @pytest.mark.asyncio
    async def test_get_safety_events_invalid_limit(
        self, safety_repository, mock_database
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_safety_events_database_error(
        self, safety_repository, mock_database
    ):
...
class TestSafetyAlerts:
    ...
    @pytest.mark.asyncio
    async def test_send_safety_alert_missing_fields(
        self, safety_repository, mock_database
    ):
    ...
    @pytest.mark.asyncio
    async def test_send_safety_alert_critical_scenarios(
        self, safety_repository, mock_database
    ):
    ...
    @pytest.mark.asyncio
    async def test_send_safety_alert_security_violation(
        self, safety_repository, mock_database
    ):
...
class TestSafetyRepositoryEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_record_multiple_concurrent_events(
        self, safety_repository, mock_database
    ):
