...
class TestChildManagement:
    ...
    @pytest.mark.asyncio
    async def test_create_child_success(self, database_service, mock_database, mock_session, sample_child_data):
    ...
    @pytest.mark.asyncio
    async def test_create_child_duplicate_error(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_get_child_success(self, database_service, mock_database, mock_session, sample_child_data):
    ...
    @pytest.mark.asyncio
    async def test_get_child_not_found(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_update_child_success(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_update_child_not_found(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_delete_child_success(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_get_children_by_parent(self, database_service, mock_database, mock_session):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_database_connection_error(self, database_service, mock_database, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_transaction_rollback(self, database_service, mock_database, mock_session):
...
class TestDatabaseInitialization:
    ...
    def test_init_database_service(self):
        ...
        from src.infrastructure.persistence.real_database_service import init_database_service
    ...
    def test_get_database_service_lazy_init(self):
        ...
        from src.infrastructure.persistence.real_database_service import get_database_service, reset_database_service
