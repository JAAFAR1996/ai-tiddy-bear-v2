...
class TestAuthService:
    ...
    def test_user_authentication_success(self):
        ...
        user = self.auth_service.authenticate_user("parent@example.com", "TestSecurePass2025!")  # ✅ 
    ...
    def test_user_authentication_failure(self):
        ...
        user = self.auth_service.authenticate_user("nonexistent@example.com", "TestSecurePass2025!")  # ✅ 
        assert user is None
