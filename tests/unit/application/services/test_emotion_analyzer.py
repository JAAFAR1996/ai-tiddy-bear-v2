...
class TestEmotionAnalyzer:
    ...
    @pytest.mark.parametrize("arousal,valence", [
    ...
    def test_map_emotion_to_voice_arousal_valence_combinations(self, service, arousal, valence):
