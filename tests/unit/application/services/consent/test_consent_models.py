...
class TestVerificationMethod:
    ...
    def test_verification_method_values(self):
        ...
        assert VerificationMethod.GOVERNMENT_ID_VERIFICATION == "government_id_verification"
    ...
    def test_verification_method_string_representation(self):
        ...
        assert str(VerificationMethod.EMAIL_VERIFICATION) == "VerificationMethod.EMAIL_VERIFICATION"
...
class TestVerificationAttempt:
    ...
    def test_verification_attempt_dataclass_behavior(self, sample_verification_attempt):
        ...
        assert sample_verification_attempt.method == VerificationMethod.EMAIL_VERIFICATION
