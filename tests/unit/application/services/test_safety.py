...
class TestSafetyService:
    ...
    def test_initialization(self, safety_service, safety_config, mock_ai_provider, mock_performance_monitor):
    ...
    @pytest.mark.asyncio
    async def test_analyze_emotional_impact_success(self, safety_service, mock_ai_provider):
    ...
    @pytest.mark.asyncio
    async def test_analyze_emotional_impact_ai_error(self, safety_service, mock_ai_provider):
        """Test emotional impact analysis with AI provider error."""
        content = "Test content"
        result = SafetyAnalysisResult(original_content=content)
        mock_ai_provider.analyze_emotion.side_effect = Exception("Emotion analysis failed")
    ...
    @pytest.mark.asyncio
    async def test_analyze_educational_value_success(self, safety_service, mock_ai_provider):
    ...
    @pytest.mark.asyncio
    async def test_analyze_educational_value_ai_error(self, safety_service, mock_ai_provider):
        """Test educational value analysis with AI provider error."""
        content = "Test content"
        result = SafetyAnalysisResult(original_content=content)
        mock_ai_provider.evaluate_educational_value.side_effect = Exception("Educational analysis failed")
        ...
        with patch.object(safety_service, 'logger') as mock_logger:
            ...
            assert result.risk_level == RiskLevel.CRITICAL
            assert len(result.modifications) == 1
            assert "Educational value analysis error" in result.modifications[0].description
    ...
    async def test_analyze_context_ai_error(self, safety_service, mock_ai_provider):
        ...
        context = {"test": "data"}
        result = SafetyAnalysisResult(original_content="test")
        mock_ai_provider.analyze_context.side_effect = Exception("Context analysis failed")
    ...
    @pytest.mark.asyncio
    async def test_analyze_content_comprehensive(self, safety_service, mock_ai_provider, mock_performance_monitor):
        ...
        mock_ai_provider.analyze_emotion.return_value = "joy"
        mock_ai_provider.evaluate_educational_value.return_value = {"score": 0.9, "topics": ["animals"]}
        mock_ai_provider.analyze_context.return_value = {"is_personal_info": False, "is_sensitive_topic": False}
        ...
        mock_performance_monitor.record_safety_check.assert_called_once_with(result="total_checked")
    
    @pytest.mark.asyncio
    async def test_analyze_content_unsafe_result(self, safety_service, mock_ai_provider, mock_performance_monitor):
        ...
        mock_ai_provider.evaluate_educational_value.return_value = {"score": 0.0, "topics": []}
    ...
    @pytest.mark.asyncio
    async def test_analyze_content_without_context(self, safety_service, mock_ai_provider):
        ...
        mock_ai_provider.evaluate_educational_value.return_value = {"score": 0.5, "topics": []}
    ...
    @pytest.mark.asyncio
    async def test_concurrent_content_analysis(self, safety_service, mock_ai_provider, mock_performance_monitor):
        ...
        mock_ai_provider.analyze_toxicity.return_value = 0.1
        mock_ai_provider.analyze_emotion.return_value = "neutral"
        mock_ai_provider.evaluate_educational_value.return_value = {"score": 0.7, "topics": []}
    ...
    async def test_modification_tracking(self, safety_service, mock_ai_provider):
        ...
        mock_ai_provider.evaluate_educational_value.side_effect = Exception("Educational error")
    ...
    @pytest.mark.parametrize("toxicity_score,expected_safe", [
        (0.0, True),
        (0.3, True), 
        (0.6, True),
    ...
    @pytest.mark.asyncio
    async def test_toxicity_threshold_boundaries(self, safety_service, mock_ai_provider, toxicity_score, expected_safe):
    ...
    async def test_error_handling_comprehensive(self, safety_service, mock_ai_provider):
        ...
        mock_ai_provider.evaluate_educational_value.side_effect = Exception("Educational failed")
        ...
        with patch.object(safety_service, 'logger'):
            ...
            assert result.original_content == content
            assert result.risk_level == RiskLevel.CRITICAL
            assert len(result.modifications) >= 4  # One for each failed analysis