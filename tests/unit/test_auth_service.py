...
def sample_user():
    ...
    return {
        ...
        "password_hash": "$2b$12$KIXSGTyIgE7h8DVPZX.5NOCjGz2xEt7FLWXB5v7Y8Kj3TjKjH5K8a"  # "TestSecurePass2025!"  # ✅ 
    }
...
class TestTokenManagement:
    ...
    @pytest.mark.asyncio
    async def test_verify_token_blacklisted(self, auth_service, sample_user, mock_redis):
