...
class TestFileValidators:
    ...
    def test_validate_audio_file_success(self, mock_logger, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    @patch('src.utils.file_validators.logger')
    def test_validate_audio_file_all_allowed_mime_types(self, mock_logger, mock_magic, mock_upload_file):
    ...
    def test_validate_audio_file_size_too_large(self, large_mock_upload_file):
        ...
        assert f"{MAX_FILE_SIZE / 1024 / 1024} MB" in str(exc_info.value.detail)

    @patch('src.utils.file_validators.magic.from_buffer')
    @patch('src.utils.file_validators.logger')
    def test_validate_audio_file_unsupported_mime_type(self, mock_logger, mock_magic, mock_upload_file):
        ...
        assert f"Unsupported file type: {unsupported_mime}" in str(exc_info.value.detail)
        assert "Allowed types are:" in str(exc_info.value.detail)
        mock_logger.warning.assert_called_once_with(f"Invalid file type uploaded: {unsupported_mime}")

    @patch('src.utils.file_validators.magic.from_buffer')
    @patch('src.utils.file_validators.logger')
    def test_validate_audio_file_dangerous_mime_types(self, mock_logger, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_file_read_error(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_magic_library_error(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_empty_file(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_file_seek_behavior(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_exact_size_limit(self, mock_magic, mock_upload_file):
    ...
    def test_validate_audio_file_boundary_size_over_limit(self, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_case_sensitivity(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_partial_mime_match(self, mock_magic, mock_upload_file):
    ...
    @pytest.mark.parametrize("file_size", [0, 1, 1024, 1024*1024, MAX_FILE_SIZE])
    def test_validate_audio_file_various_valid_sizes(self, file_size, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_none_filename(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_special_characters_filename(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_unicode_filename(self, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    @patch('src.utils.file_validators.logger')
    def test_validate_audio_file_logging_behavior(self, mock_logger, mock_magic, mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    @patch('src.utils.file_validators.logger')
    def test_validate_audio_file_warning_logging(self, mock_logger, mock_magic, mock_upload_file):
        ...
        mock_logger.warning.assert_called_once_with(f"Invalid file type uploaded: {invalid_mime}")

    def test_validate_audio_file_error_message_format(self, large_mock_upload_file):
    ...
    @patch('src.utils.file_validators.magic.from_buffer')
    def test_validate_audio_file_unsupported_type_error_message(self, mock_magic, mock_upload_file):
