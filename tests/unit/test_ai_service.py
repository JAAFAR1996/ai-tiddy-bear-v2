...
class TestContentGeneration:
    ...
    @pytest.mark.asyncio
    async def test_generate_response_success(self, ai_service, mock_openai_client, child_context):
    ...
    @pytest.mark.asyncio
    async def test_generate_response_with_context(self, ai_service, mock_openai_client, child_context):
    ...
    @pytest.mark.asyncio
    async def test_generate_response_unsafe_content(self, ai_service, mock_openai_client, child_context):
    ...
    @pytest.mark.asyncio
    async def test_generate_response_with_caching(self, ai_service, mock_openai_client, mock_redis, child_context):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_openai_api_error(self, ai_service, mock_openai_client, child_context):
    ...
    @pytest.mark.asyncio
    async def test_rate_limit_error(self, ai_service, mock_openai_client, child_context):
