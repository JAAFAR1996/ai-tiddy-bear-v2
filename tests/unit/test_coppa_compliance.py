...
class TestParentalConsent:
    ...
    @pytest.mark.asyncio
    async def test_validate_consent_invalid_email(self, coppa_service, valid_consent_data):
...
class TestConsentRecord:
    ...
    @pytest.mark.asyncio
    async def test_create_consent_record_success(self, coppa_service, valid_consent_data):
    ...
    @pytest.mark.asyncio
    async def test_create_consent_record_with_database(self, coppa_service, valid_consent_data, mock_database):
