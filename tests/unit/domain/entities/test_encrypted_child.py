...
class TestEncryptedChild:
    ...
    def test_emergency_contacts_encryption(self, mock_encrypted_field):
        ...
        mock_instance.decrypt.return_value = [{"name": "Parent", "phone": "123-456-7890"}]
    ...
    def test_to_dict_serialization(self):
        ...
        assert result["learning_preferences"] == {"visual": 0.8, "auditory": 0.2}
