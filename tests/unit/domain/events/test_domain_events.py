...
class TestEventVersioning:
    ...
    def test_version_ordering(self):
        ...
        events = [
            ChildRegistered(aggregate_id=child_id, child_id=child_id, name="Test", age=5, preferences={}, version=3),
            ChildProfileUpdated(aggregate_id=child_id, child_id=child_id, name="Test", age=5, preferences={}, version=1),
            ConversationStarted(aggregate_id=uuid4(), conversation_id=uuid4(), child_id=child_id, initial_message="Hi", version=2)
        ]
