...
class TestCOPPAAgeValidator:
    ...
    def test_get_safety_level_all_results(self):
        ...
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.VALID_CHILD) == "high_protection"
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.VALID_TEEN) == "moderate_protection"
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.VALID_ADULT) == "standard_protection"
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.TOO_YOUNG) == "blocked"
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.INVALID_AGE) == "blocked"
        assert COPPAAgeValidator._get_safety_level(AgeValidationResult.MISSING_BIRTHDATE) == "blocked"
    ...
    def test_get_compliance_notes_all_results(self):
        ...
        notes = COPPAAgeValidator._get_compliance_notes(AgeValidationResult.MISSING_BIRTHDATE)
