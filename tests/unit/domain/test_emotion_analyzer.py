...
class TestEmotionAnalyzer:
    ...
    def test_initialization(self, analyzer):
        ...
        assert analyzer._positive_emotions == {"happy", "excited", "calm", "curious", "proud"}
        assert analyzer._negative_emotions == {"sad", "angry", "frustrated", "scared", "worried"}
    ...
    def test_requires_attention_high_arousal_negative_sentiment(self, analyzer):
        ...
        result = EmotionResult("excited", 0.7, {"excited": 0.7}, 
                             sentiment_score=-0.4, arousal_score=0.9)
        assert analyzer.requires_attention(result) is True
    ...
    def test_case_insensitive_analysis(self, analyzer):
        ...
        assert result1.primary_emotion == result2.primary_emotion == result3.primary_emotion
