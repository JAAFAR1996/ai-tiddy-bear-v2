...
class TestGenerateAIResponseUseCase:
    ...
    async def test_execute_success(self, use_case, ai_response):
        ...
        use_case.audio_processing_service.generate_audio_response.return_value = audio_data
    ...
    async def test_execute_unsafe_content_handling(self, use_case):
        ...
        use_case.audio_processing_service.generate_audio_response.return_value = b"safety_audio"
    ...
    @pytest.mark.asyncio
    async def test_execute_with_complex_conversation_history(self, use_case, ai_response):
    ...
    async def test_execute_audio_generation_failure(self, use_case, ai_response):
        ...
        use_case.ai_orchestration_service.get_ai_response.return_value = ai_response
        use_case.audio_processing_service.generate_audio_response.side_effect = Exception("Audio service unavailable")
    ...
    async def test_execute_with_different_languages(self, use_case):
        ...
        use_case.ai_orchestration_service.get_ai_response.return_value = spanish_response
        use_case.audio_processing_service.generate_audio_response.return_value = b"spanish_audio"
    ...
    async def test_execute_emotional_response_tracking(self, use_case):
        ...
        use_case.ai_orchestration_service.get_ai_response.return_value = empathetic_response
        use_case.audio_processing_service.generate_audio_response.return_value = b"empathetic_audio"
