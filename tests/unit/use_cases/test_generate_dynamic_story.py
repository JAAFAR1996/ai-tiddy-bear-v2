...
class TestGenerateDynamicStoryUseCase:
    ...
    @pytest.mark.asyncio
    async def test_execute_success(self, use_case, story_request, child_profile, story_response):
        ...
        use_case.child_repository.get_by_id.assert_called_once_with(story_request.child_id)
    ...
    @pytest.mark.asyncio
    async def test_execute_personalized_story(self, use_case, child_profile, story_response):
    ...
    @pytest.mark.asyncio
    async def test_execute_age_appropriate_content(self, use_case, child_profile, story_request):
        ...
        use_case.child_repository.get_by_id.return_value = child_profile
        use_case.dynamic_story_service.generate_story.return_value = age_appropriate_story
    ...
    @pytest.mark.asyncio
    async def test_execute_with_custom_characters(self, use_case, child_profile, story_response):
    ...
    @pytest.mark.asyncio
    async def test_execute_safety_validation(self, use_case, child_profile, story_request):
        ...
        use_case.child_repository.get_by_id.return_value = child_profile
        use_case.dynamic_story_service.generate_story.return_value = potentially_unsafe_story
    ...
    async def test_execute_story_length_preferences(self, use_case, child_profile):
        ...
        assert "short" in use_case.dynamic_story_service.generate_story.call_args[1]['story_length']

    @pytest.mark.asyncio
    async def test_execute_multilingual_support(self, use_case, child_profile, story_request):
    ...
    @pytest.mark.asyncio
    async def test_execute_moral_lesson_integration(self, use_case, child_profile, story_request):
