...
class TestProcessESP32AudioUseCase:
    ...
    async def test_execute_success_flow(
            self, use_case, esp32_request, child_profile, ai_response):
    ...
    @pytest.mark.asyncio
    async def test_execute_critical_safety_level(
            self, use_case, esp32_request):
    ...
    @pytest.mark.asyncio
    async def test_execute_updates_child_preferences(
            self, use_case, esp32_request, child_profile, ai_response):
    ...
    @pytest.mark.asyncio
    async def test_execute_conversation_tracking(
            self, use_case, esp32_request, child_profile, ai_response):
    ...
    @pytest.mark.asyncio
    async def test_execute_audio_generation(
            self, use_case, esp32_request, child_profile, ai_response):
