...
def _calculate_average_security_score(test_suites: Dict[str, TestSuite]) -> float:
...
def _calculate_average_child_safety_score(test_suites: Dict[str, TestSuite]) -> float:
