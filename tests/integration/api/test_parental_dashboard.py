...
class TestParentalDashboardEndpoints:
    ...
    async def test_get_safety_report(self, client, auth_headers, child_data):
        ...
        mock_safety_report = {
            ...
            "content_categories": {"educational": 25, "entertainment": 15, "social": 5},
            "emotion_analysis": {
                "happy": 60,
                "curious": 25,
                "excited": 10,
    ...
    async def test_get_usage_analytics(self, client, auth_headers, child_data):
        ...
        with patch(
            ...
            response = await client.get(
                f"/api/v1/dashboard/children/{child_id}/analytics", headers=auth_headers
            )
    ...
    async def test_input_validation(self, client, auth_headers):
        ...
        response = await client.post(
            "/api/v1/dashboard/children", json=invalid_child_data, headers=auth_headers
        )
