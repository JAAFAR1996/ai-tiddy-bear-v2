...
try:
    from infrastructure.security.homomorphic_encryption import HomomorphicEncryptionService, TENSEAL_AVAILABLE, EncryptedData, HEConfig, HEScheme, HomomorphicEncryption
