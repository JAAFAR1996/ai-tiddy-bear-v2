...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('coppa_consent_given', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_table(
        'children',
        sa.Column('id', postgresql.UUID(as_uuid=False), primary_key=True, default=str(uuid.uuid4())),
        sa.Column('parent_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
        sa.Column('name', sa.String(100), nullable=False),
        sa.Column('age', sa.Integer(), nullable=False),
        sa.Column('date_of_birth', sa.Date(), nullable=True),
        sa.Column('avatar_url', sa.Text(), nullable=True),
        sa.Column('preferences', postgresql.JSONB(), nullable=True, default={}),
        sa.Column('safety_settings', postgresql.JSONB(), nullable=True, default={}),
        ...
        sa.Column('parental_consent_verified', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_table(
        'conversations',
        sa.Column('id', postgresql.UUID(as_uuid=False), primary_key=True, default=str(uuid.uuid4())),
        sa.Column('child_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('children.id', ondelete='CASCADE'), nullable=False),
        ...
        sa.Column('content_moderation_result', postgresql.JSONB(), nullable=True),
        ...
        sa.Column('flagged_content', sa.Boolean(), nullable=False, default=False),
        sa.Column('parent_reviewed', sa.Boolean(), nullable=False, default=False),
        sa.Column('is_archived', sa.Boolean(), nullable=False, default=False),
        comment='AI conversations with comprehensive safety tracking'
    )
    
    # Create indexes for conversations table
    op.create_index('idx_conversations_child_id', 'conversations', ['child_id'])
    op.create_index('idx_conversations_timestamp', 'conversations', ['timestamp'])
    op.create_index('idx_conversations_safety', 'conversations', ['safety_score'])
    op.create_index('idx_conversations_flagged', 'conversations', ['flagged_content'])
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=False), primary_key=True, default=str(uuid.uuid4())),
        sa.Column('child_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('children.id', ondelete='CASCADE'), nullable=False),
        sa.Column('conversation_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('conversations.id', ondelete='CASCADE'), nullable=True),
        sa.Column('event_type', sa.String(100), nullable=False),
        sa.Column('severity', sa.String(20), nullable=False),
        sa.Column('description', sa.Text(), nullable=False),
        sa.Column('automated_action', sa.String(100), nullable=True),
        sa.Column('parent_notified', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_index('idx_safety_events_child_id', 'safety_events', ['child_id'])
    op.create_index('idx_safety_events_severity', 'safety_events', ['severity'])
    op.create_index('idx_safety_events_timestamp', 'safety_events', ['timestamp'])
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=False), primary_key=True, default=str(uuid.uuid4())),
        sa.Column('parent_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
        sa.Column('child_id', postgresql.UUID(as_uuid=False), sa.ForeignKey('children.id', ondelete='CASCADE'), nullable=True),
        sa.Column('consent_type', sa.String(100), nullable=False),
        sa.Column('consent_given', sa.Boolean(), nullable=False),
        sa.Column('consent_date', sa.DateTime(), nullable=False, server_default=sa.func.now()),
    ...
    op.create_index('idx_parental_consents_parent', 'parental_consents', ['parent_id'])
    op.create_index('idx_parental_consents_child', 'parental_consents', ['child_id'])
    op.create_index('idx_parental_consents_type', 'parental_consents', ['consent_type'])
    op.create_index('idx_parental_consents_date', 'parental_consents', ['consent_date'])
