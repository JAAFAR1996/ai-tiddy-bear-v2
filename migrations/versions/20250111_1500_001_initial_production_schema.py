...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'id', postgresql.UUID(
                as_uuid=False), primary_key=True, default=str(
                uuid.uuid4())),
        sa.Column(
            'email',
            sa.String(255),
    ...
    op.create_index(
        'idx_safety_events_child_id',
        'safety_events',
        ['child_id'])
    op.create_index(
        'idx_safety_events_severity',
        'safety_events',
        ['severity'])
    op.create_index(
        'idx_safety_events_timestamp',
        'safety_events',
        ['timestamp'])
    ...
    op.create_table(
        ...
        sa.Column(
            'child_id', postgresql.UUID(
                as_uuid=False), sa.ForeignKey(
                'children.id', ondelete='CASCADE'), nullable=True),
    ...
    op.create_index(
        'idx_parental_consents_parent',
        'parental_consents',
        ['parent_id'])
    op.create_index(
        'idx_parental_consents_child',
        'parental_consents',
        ['child_id'])
    op.create_index(
        'idx_parental_consents_type',
        'parental_consents',
        ['consent_type'])
    op.create_index(
        'idx_parental_consents_date',
        'parental_consents',
        ['consent_date'])
