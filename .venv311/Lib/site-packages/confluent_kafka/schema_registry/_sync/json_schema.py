...
def _resolve_named_schema(
    ...
    if schema.references is not None:
        for ref in schema.references:
            ...
            ref_registry = _resolve_named_schema(
...
class JSONDeserializer(BaseDeserializer):
    ...
    def __init_impl(
        ...
        if schema:
            self._reader_schema, self._ref_registry = self._get_parsed_schema(
                self._schema
            )
        else:
    ...
    def __serialize(
        ...
        if self._registry is not None:
            ...
            writer_schema, writer_ref_registry = self._get_parsed_schema(
                writer_schema_raw
            )
            if subject is None:
        ...
        if latest_schema is not None:
            ...
            reader_schema, reader_ref_registry = self._get_parsed_schema(
                latest_schema.schema
            )
