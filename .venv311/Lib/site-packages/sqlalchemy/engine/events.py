...
from .interfaces import ConnectionEventsTarget, DBAPIConnection, DBAPICursor, Dialect
...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    ) -> Optional[Tuple[Executable, _CoreMultiExecuteParams, _CoreSingleExecuteParams]]:
