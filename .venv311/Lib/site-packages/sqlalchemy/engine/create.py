...
import inspect
import typing
from typing import Any, Callable, Dict, List, Optional, Type, Union, cast, overload

from .. import event, exc, util
from ..pool import ConnectionPoolEntry, _AdhocProxiedConnection
...
if typing.TYPE_CHECKING:
    ...
    from ..pool import Pool, _CreatorFnType, _CreatorWRecFnType, _ResetStyleArgType
    from ..util.typing import Literal
    from .base import Engine
    from .interfaces import IsolationLevel, _ExecuteOptions, _ParamStyle
    from .url import URL
