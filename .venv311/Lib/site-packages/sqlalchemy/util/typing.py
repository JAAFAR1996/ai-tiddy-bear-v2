...
if True:  # zimports removes the tailing comments
    ...
    from typing_extensions import dataclass_transform as dataclass_transform  # 3.11,
    from typing_extensions import final as final  # 3.8
...
def eval_expression(
    ...
    *,
    ...
    try:
        ...
        raise NameError(f"Could not de-stringify annotation {expression!r}") from err
    else:
        return annotation
...
def eval_name_only(
    ...
    *,
    ...
    try:
        ...
        raise NameError(f"Could not locate name {name} in module {module_name}") from ke
...
def is_fwd_ref(
    ...
    if check_for_plain_string and isinstance(type_, str):
        ...
        return any(
            is_fwd_ref(arg, True, check_for_plain_string=check_for_plain_string)
