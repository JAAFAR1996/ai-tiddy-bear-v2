...
from .typing import Literal, Protocol, is_non_string_iterable
...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from sqlalchemy.cyextension.collections import unique_list as unique_list  # noqa
    ...
    from sqlalchemy.cyextension.immutabledict import immutabledict as immutabledict
...
class ScopedRegistry(Generic[_T]):
    ...
    def __init__(self, createfunc: Callable[[], _T], scopefunc: Callable[[], Any]):
