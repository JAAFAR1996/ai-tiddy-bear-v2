...
from .. import ColumnElement, exc, inspect, orm, util
from ..orm import InspectionAttrExtensionType, ORMDescriptor, collections, interfaces
from ..orm.base import SQLORMOperations
from ..orm.interfaces import (
    _DEFAULT_ATTRIBUTE_OPTIONS,
    _AttributeOptions,
    _DCAttributeOptions,
)
from ..sql import operators, or_
from ..sql.base import _NoArg
from ..util.typing import Literal, Protocol, Self, SupportsIndex, SupportsKeysAndGetItem

if typing.TYPE_CHECKING:
    from ..orm.interfaces import MapperProperty, PropComparator
            ...
            if step == 1:
                ...
                if len(sized_value) != len(rng):
                    raise ValueError(
                        ...
                        "extended slice of size %s" % (len(sized_value), len(rng))
                    )
