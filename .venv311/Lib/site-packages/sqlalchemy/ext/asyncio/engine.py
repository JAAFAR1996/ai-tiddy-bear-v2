...
class AsyncConnection(
    ...
    async def start(self, is_ctxmanager: bool = False) -> AsyncConnection:  # noqa: U100
    ...
    async def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        return await greenlet_spawn(self._proxied.invalidate, exception=exception)
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        return await greenlet_spawn(fn, self._proxied, *arg, _require_await=False, **kw)
