...
from typing import Any, Callable, Iterable, NoReturn, Optional, Tuple, TypeVar, Union
...
def combinations(
    ...
    **kw: str,
    ...
    """
    return _fixture_functions.combinations(*comb, id_=id_, argnames=argnames, **kw)
...
def variation(argname_or_fn, cases=None):
    ...
    return combinations(
        *[
            ...
            for variation, (case, limitation) in zip(variations, cases_plus_limitations)
        ],
        id_="ia",
        argnames=argname,
    )
