...
from ..sql._orm_types import SynchronizeSessionArgument as SynchronizeSessionArgument
from ..sql._typing import _HasClauseElement
from ..sql.elements import ColumnElement
from ..util.typing import Protocol, TypeGuard
...
if TYPE_CHECKING:
    ...
    from .interfaces import InspectionAttr, MapperProperty, ORMOption, UserDefinedOption
...
def is_composite_class(obj: Any) -> bool:
    ...
    return hasattr(obj, "__composite_values__") or hasattr(obj, "__dataclass_fields__")
...
if TYPE_CHECKING:
    ...
    is_has_collection_adapter = operator.attrgetter("_is_has_collection_adapter")
