...
from ._typing import _O, is_collection_impl
from .base import (
    ATTR_WAS_SET,
    INIT_OK,
    NEVER_SET,
...
if TYPE_CHECKING:
    ...
    from ._typing import _IdentityKeyType, _InstanceDict, _LoaderCallable
    from .attributes import AttributeImpl, History
