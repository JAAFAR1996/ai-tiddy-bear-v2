...
from ..sql.base import ExecutableOption, _NoArg
from ..sql.cache_key import HasCacheKey
from ..sql.operators import ColumnOperators
from ..sql.schema import Column
from ..sql.type_api import TypeEngine
from ..util import warn_deprecated
from ..util.typing import RODescriptorReference, TypedDict
...
if typing.TYPE_CHECKING:
    ...
    from .util import AliasedInsp, ORMAdapter
...
class StrategizedProperty(MapperProperty[_T]):
    ...
    def post_instrument_class(self, mapper: Mapper[Any]) -> None:
        if not self.parent.non_primary and not mapper.class_manager._attr_has_impl(
            self.key
        ):
