...
if TYPE_CHECKING:
    ...
    from .attributes import AttributeImpl, QueryableAttribute
...
class ClassManager(
    ...
    def __init__(self, class_):
        ...
        cast("InstanceEvents", self.dispatch._events)._new_classmanager_instance(
            class_, self
        )
    ...
    def _scalar_loader_impls(self):
        return frozenset(
            [attr.impl for attr in self.values() if attr.impl.accepts_scalar_loader]
        )
    ...
    def _new_state_if_none(
        ...
        if hasattr(instance, self.STATE_ATTR):
            ...
            return self._subclass_manager(instance.__class__)._new_state_if_none(
                instance
            )
        else:
            state = self._state_constructor(instance, self)
