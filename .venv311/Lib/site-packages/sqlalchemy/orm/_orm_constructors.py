...
from ..sql.base import SchemaEventTarget, _NoArg
from ..sql.schema import SchemaConst, _InsertSentinelColumnDefault
from ..sql.selectable import FromClause
from ..util.typing import Annotated, Literal
from . import mapperlib as mapperlib
from ._typing import _O
from .descriptor_props import Composite, Synonym
from .interfaces import _AttributeOptions
from .properties import MappedColumn, MappedSQLExpression
...
from .util import AliasedClass, AliasedInsp, LoaderCriteriaOption, _ORMJoin
...
if TYPE_CHECKING:
    ...
    from ..sql.schema import _ServerDefaultArgument, _ServerOnUpdateArgument
    from ..sql.selectable import Alias, Subquery
    from ._typing import _EntityType, _ORMColumnExprArgument
    from .descriptor_props import _CC, _CompositeAttrType
