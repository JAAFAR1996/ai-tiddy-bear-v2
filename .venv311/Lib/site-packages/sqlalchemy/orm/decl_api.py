...
from ._orm_constructors import composite, deferred, mapped_column, relationship, synonym
from .attributes import InstrumentedAttribute
from .base import Mapped, ORMDescriptor, _inspect_mapped_class, _is_mapped_class
from .decl_base import (
    _add_attribute,
    _as_declarative,
...
def _check_not_declarative(cls: Type[Any], base: Type[Any]) -> None:
    ...
    if (
        ...
        and not (
            callable(cls_dict["__table__"]) or hasattr(cls_dict["__table__"], "__get__")
        )
