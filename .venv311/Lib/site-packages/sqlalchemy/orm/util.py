...
from .. import inspection, sql, util
from ..engine.result import result_tuple
from ..sql import coercions, expression, lambdas, roles
from ..sql import util as sql_util
from ..sql import visitors
from ..sql._typing import is_selectable
from ..sql.annotation import SupportsCloneAnnotations
from ..sql.base import ColumnCollection
from ..sql.cache_key import HasCacheKey, MemoizedHasCacheKey
from ..sql.elements import ColumnElement, KeyedColumnElement
...
from ..util.typing import fixup_container_fwd_refs, get_origin, is_origin_of_cls
from . import attributes  # noqa
from . import exc
from . import exc as orm_exc
from ._typing import _O, insp_is_aliased_class, insp_is_mapper, prop_is_relationship
from .base import DynamicMapped
from .base import InspectionAttr as InspectionAttr
from .base import Mapped, ORMDescriptor, WriteOnlyMapped
...
if typing.TYPE_CHECKING:
    ...
    from ..sql.selectable import Select, Selectable, _ColumnsClauseElement
    from ..sql.visitors import anon_map
    from ..util.typing import _AnnotationScanType
    from ._typing import _ORMCOLEXPR, _EntityType, _IdentityKeyType, _InternalEntityType
    from .context import ORMCompileState, _MapperEntity
...
class Bundle(
    ...
    def __init__(self, name: str, *exprs: _ColumnExpressionArgument[Any], **kw: Any):
    ...
    def mapper(self) -> Optional[Mapper[Any]]:
        mp: Optional[Mapper[Any]] = self.exprs[0]._annotations.get("parentmapper", None)
        return mp

    @property
    def entity(self) -> Optional[_InternalEntityType[Any]]:
        ie: Optional[_InternalEntityType[Any]] = self.exprs[0]._annotations.get(
            "parententity", None
        )
        return ie
...
def with_parent(
    ...
    if isinstance(prop, str):
        ...
        if mapper_property is None or not prop_is_relationship(mapper_property):
            raise sa_exc.ArgumentError(
