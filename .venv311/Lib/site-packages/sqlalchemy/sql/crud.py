...
from .schema import default_is_clause_element, default_is_sequence
from .selectable import Select, TableClause

if TYPE_CHECKING:
    from .compiler import SQLCompiler, _BindNameForColProtocol
    from .dml import DMLState, ValuesBase, _DMLColumnElement
    from .elements import ColumnElement, KeyedColumnElement
    from .schema import Column, _SQLExprDefault
...
def _get_returning_modifiers(compiler, stmt, compile_state, toplevel):
    ...
    if _compile_state_isinsert(compile_state):
        ...
        use_insertmanyvalues = (
            ...
            and (explicit_returning or dialect.use_insertmanyvalues_wo_returning)
        )
