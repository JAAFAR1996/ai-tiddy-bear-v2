...
from .. import util
from . import annotation, coercions, operators, roles, schema, sqltypes, type_api
...
if TYPE_CHECKING:
    ...
    from ..engine.interfaces import CoreExecuteOptionsParameter, _CoreMultiExecuteParams
...
_registry: util.defaultdict[str, Dict[str, Type[Function[Any]]]] = util.defaultdict(
    dict
)
...
class GenericFunction(Function[_T]):
    ...
    def __init__(
        ...
        self.clause_expr = Grouping(
            ClauseList(operator=operators.comma_op, group_contents=True, *parsed_args)
        )
