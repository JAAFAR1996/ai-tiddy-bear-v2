...
from ..._types import NOT_GIVEN, Body, FileTypes, Headers, NotGiven, Query
from ..._utils import (
...
class Transcriptions(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        chunking_strategy: Optional[transcription_create_params.ChunkingStrategy]
        | NotGiven = NOT_GIVEN,
...
class AsyncTranscriptions(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> Transcription | TranscriptionVerbose | str | AsyncStream[
...
def _get_response_format_type(
    ...
    if (
        isinstance(response_format, NotGiven) or response_format is None
    ...
    if response_format == "json":
        ...
        response_format == "srt"
        or response_format == "text"
        or response_format == "vtt"
    ):
        return str
