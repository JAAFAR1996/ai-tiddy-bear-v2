...
class TranscriptionSessions(SyncAPIResource):
    ...
    def create(
        self,
        *,
        client_secret: transcription_session_create_params.ClientSecret
        | NotGiven = NOT_GIVEN,
        ...
        | NotGiven = NOT_GIVEN,
        input_audio_transcription: transcription_session_create_params.InputAudioTranscription
        | NotGiven = NOT_GIVEN,
        modalities: List[Literal["text", "audio"]] | NotGiven = NOT_GIVEN,
        turn_detection: transcription_session_create_params.TurnDetection
        | NotGiven = NOT_GIVEN,
