...
class RealtimeWithRawResponse:
    ...
    def transcription_sessions(self) -> TranscriptionSessionsWithRawResponse:
        return TranscriptionSessionsWithRawResponse(
            self._realtime.transcription_sessions
        )
...
class AsyncRealtimeWithRawResponse:
    ...
    def transcription_sessions(self) -> AsyncTranscriptionSessionsWithRawResponse:
        return AsyncTranscriptionSessionsWithRawResponse(
            self._realtime.transcription_sessions
        )
...
class RealtimeWithStreamingResponse:
    ...
    def transcription_sessions(self) -> TranscriptionSessionsWithStreamingResponse:
        return TranscriptionSessionsWithStreamingResponse(
            self._realtime.transcription_sessions
        )
...
class AsyncRealtimeWithStreamingResponse:
    ...
    def transcription_sessions(self) -> AsyncTranscriptionSessionsWithStreamingResponse:
        return AsyncTranscriptionSessionsWithStreamingResponse(
            self._realtime.transcription_sessions
        )
    ...
    async def send(self, event: RealtimeClientEvent | RealtimeClientEventParam) -> None:
        data = (
            ...
            if isinstance(event, BaseModel)
                ...
                await async_maybe_transform(event, RealtimeClientEventParam)
            )
        )
    ...
    def parse_event(self, data: str | bytes) -> RealtimeServerEvent:
        ...
        return cast(
            ...
            construct_type_unchecked(
                value=json.loads(data), type_=cast(Any, RealtimeServerEvent)
            ),
        )
    ...
    async def __aenter__(self) -> AsyncRealtimeConnection:
        ...
        **Warning**: You must remember to close the connection with `.close()`.
        ...
        if is_async_azure_client(self.__client):
            url, auth_headers = await self.__client._configure_realtime(
                self.__model, extra_query
            )
        else:
    ...
    def __enter__(self) -> RealtimeConnection:
        ...
        **Warning**: You must remember to close the connection with `.close()`.
        ...
        if is_azure_client(self.__client):
            url, auth_headers = self.__client._configure_realtime(
                self.__model, extra_query
            )
        else:
            url = self._prepare_url().copy_with(
    ...
    def clear(self, *, event_id: str | NotGiven = NOT_GIVEN) -> None:
        ...
        self._connection.send(
            cast(
                RealtimeClientEventParam,
                strip_not_given(
                    {"type": "input_audio_buffer.clear", "event_id": event_id}
                ),
            )
        )
    ...
    def clear(self, *, event_id: str | NotGiven = NOT_GIVEN) -> None:
        ...
        self._connection.send(
            cast(
                RealtimeClientEventParam,
                strip_not_given(
                    {"type": "output_audio_buffer.clear", "event_id": event_id}
                ),
            )
        )
...
class AsyncRealtimeConversationItemResource(BaseAsyncRealtimeConnectionResource):
    async def delete(
        self, *, item_id: str, event_id: str | NotGiven = NOT_GIVEN
    ) -> None:
        """Send this event when you want to remove any item from the conversation
        history.
