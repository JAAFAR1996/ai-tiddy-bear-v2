...
from ....._utils import async_maybe_transform, is_given, maybe_transform, required_args
...
class Runs(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                run_create_params.RunCreateParamsStreaming
                if stream
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include": include}, run_create_params.RunCreateParams
                ),
            ),
            cast_to=Run,
    ...
    def poll(
        ...
        while True:
            response = (
                self.with_raw_response.retrieve(  # pyright: ignore[reportDeprecated]
                    thread_id=thread_id,
                    run_id=run_id,
                    extra_headers=extra_headers,
                    extra_body=extra_body,
...
class RunsWithStreamingResponse:
    def __init__(self, runs: Runs) -> None:
        ...
        self.create = to_streamed_response_wrapper(  # pyright: ignore[reportDeprecated]
            runs.create  # pyright: ignore[reportDeprecated],
        )
        self.retrieve = (  # pyright: ignore[reportDeprecated]
            to_streamed_response_wrapper(
        ...
        self.update = to_streamed_response_wrapper(  # pyright: ignore[reportDeprecated]
            runs.update  # pyright: ignore[reportDeprecated],
        )
        self.list = to_streamed_response_wrapper(  # pyright: ignore[reportDeprecated]
            runs.list  # pyright: ignore[reportDeprecated],
        )
        self.cancel = to_streamed_response_wrapper(  # pyright: ignore[reportDeprecated]
            runs.cancel  # pyright: ignore[reportDeprecated],
        )
        self.submit_tool_outputs = (  # pyright: ignore[reportDeprecated]
            to_streamed_response_wrapper(
