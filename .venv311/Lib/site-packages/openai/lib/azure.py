...
import inspect
import os
from typing import Any, Awaitable, Callable, Mapping, TypeVar, Union, cast, overload
...
from .._types import NOT_GIVEN, NotGiven, Omit, Query, Timeout
    ...
    def _prepare_url(self, url: str) -> httpx.URL:
        ...
        if (
            ...
            if merge_url.is_relative_url:
                merge_raw_path = (
                    self._azure_endpoint.raw_path.rstrip(b"/")
                    + b"/openai/"
