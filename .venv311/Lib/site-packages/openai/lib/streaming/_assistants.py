...
import httpx
from typing_extensions import AsyncIterable, AsyncIterator, Awaitable, assert_never

from ..._compat import model_dump
from ..._models import construct_type
from ..._streaming import AsyncStream, Stream
from ..._utils import consume_async_iterator, consume_sync_iterator, is_dict, is_list
...
from ...types.beta.threads.runs import RunStep, RunStepDelta, ToolCall, ToolCallDelta
                ...
                current_message_snapshot.content.insert(
                    ...
                    cast(
                        ...
                        construct_type(
                            ...
                            value=model_dump(
                                content_delta, exclude_unset=True, warnings=False
                            ),
                        ),
                    ),
                )
