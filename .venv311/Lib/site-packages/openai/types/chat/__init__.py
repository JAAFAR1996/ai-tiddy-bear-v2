...
from .chat_completion_audio_param import (
    ChatCompletionAudioParam as ChatCompletionAudioParam,
)
...
from .chat_completion_reasoning_effort import (
    ChatCompletionReasoningEffort as ChatCompletionReasoningEffort,
)
from .chat_completion_store_message import (
    ChatCompletionStoreMessage as ChatCompletionStoreMessage,
)
