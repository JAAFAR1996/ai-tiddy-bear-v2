...
Source: TypeAlias = Annotated[
    Union[SourceFileContent, SourceFileID, SourceStoredCompletions],
...
InputMessagesTemplateTemplate: TypeAlias = Annotated[
    Union[EasyInputMessage, InputMessagesTemplateTemplateMessage],
    PropertyInfo(discriminator="type"),
]
...
InputMessages: TypeAlias = Annotated[
    Union[InputMessagesTemplate, InputMessagesItemReference],
    PropertyInfo(discriminator="type"),
]

SamplingParamsResponseFormat: TypeAlias = Union[
