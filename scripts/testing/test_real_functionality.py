...
def test_ai_service():
    ...
    try:
        ...
        unsafe_response = ai.generate_response(
            "I hate everything and it's stupid", 6, {}
        )
        print(
            f"✅ Safety filtering works: {unsafe_response['response'][:60]}...")
...
def main():
    ...
    tests = [test_auth_service, test_ai_service, test_basic_functionality]
