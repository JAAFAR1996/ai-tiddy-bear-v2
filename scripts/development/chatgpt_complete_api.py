...
try:
    ...
    # For now, we'll let it proceed with a warning, assuming it's for
    # demonstration.
    raise ImportError(
...
Keep responses under 150 words and end with encouragement."""
    ...
    def _analyze_message_safety(self, message: str) -> Dict[str, Any]:
        ...
        # Check for sensitive information patterns (similar to
        # APISecurityManager.validate_child_input)
        sensitive_patterns = [
...
class ChatGPTService:
    ...
    def _save_conversation(self, child_id: str,
...
async def test_complete_api():
    ...
    user_data = auth_service.create_user(
        "test@parent.com", test_password, "parent")
...
if __name__ == "__main__":
    ...
    print(
        "- GET /api/chatgpt/suggestions/{child_id} - Conversation suggestions")
