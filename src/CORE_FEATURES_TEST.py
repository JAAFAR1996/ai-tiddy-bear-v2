...
class CoreFeaturesTest:
    ...
    def test_child_safety_protection(
        ...
        try:
            ...
            self.results["features"][feature_name] = {"status": "FAILED", "error": str(e)}
...
if __name__ == "__main__":
    ...
    class MockContentFilter:
        def filter_text(self, text):
            ...
            return "unsafe" in text or "violent" in text or "inappropriate" in text or "scary" in text or "horror" in text
