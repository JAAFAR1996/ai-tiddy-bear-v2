...
class ConsentService:
    ...
    def revoke_consent(
        ...
        """
        if child_id in self.consent_cache and consent_type in self.consent_cache[child_id]:
    ...
    def get_consent_status(
        ...
        for consent_type in ConsentType:
            ...
            status[consent_type] = record.status if record else ConsentStatus.NOT_GRANTED
        return status
