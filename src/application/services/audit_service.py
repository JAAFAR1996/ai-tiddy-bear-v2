...
class AuditService:
    ...
    def __init__(self, logger: logging.Logger = get_logger(__name__, component="audit_service")) -> None:
    ...
    def create_audit_log(
        ...
        audit_data = {
            ...
            "user_agent": self._sanitize_log_input(request_info["user_agent"])[:100],  # Sanitize and truncate user agent
