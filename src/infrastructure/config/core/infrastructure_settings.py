...
class InfrastructureSettings(BaseSettings):
    ...
    # ================================
    database_url: str = Field(..., pattern="^postgresql")
    ...
    message_queue_type: str = Field("redis", pattern="^(redis|rabbitmq|kafka)$")

    # ================================
    # Storage Configuration
    # ================================
    storage_type: str = Field("s3", pattern="^(local|s3|azure|gcs)$")
