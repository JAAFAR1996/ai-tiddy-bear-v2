...
from src.infrastructure.config.core.base_settings import BaseSettings as CoreBaseSettings
...
from src.infrastructure.config.services.content_moderation_settings import ContentModerationSettings
