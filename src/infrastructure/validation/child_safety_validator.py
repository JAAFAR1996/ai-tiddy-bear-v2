    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        try:
            ...
            raise ValidationError(
                "Invalid security patterns configuration",
        ...
        try:
            ...
            if age_int < self.min_child_age:
                return ValidationResult(
                    valid=False,
                    errors=[
                        f"Age {age_int} too young for platform (minimum: {self.min_child_age})",
                    ],
                    metadata={
                        "code": "AGE_TOO_YOUNG",
            ...
            if age_int > self.max_child_age:
                return ValidationResult(
                    valid=False,
                    errors=[
                        f"Age {age_int} exceeds child platform limit (maximum: {self.max_child_age})",
                    ],
                    metadata={
                        "code": "AGE_TOO_OLD",
