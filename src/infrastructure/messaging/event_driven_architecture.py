...
def create_event(event_type: EventType, data: Dict[str, Any], user_id: Optional[str] = None) -> Event:
    return Event(data=data, metadata=EventMetadata(event_type=event_type, user_id=user_id))

def create_command(data: Dict[str, Any], user_id: Optional[str] = None) -> Command:
    return Command(data=data, user_id=user_id)

def create_query(parameters: Dict[str, Any], user_id: Optional[str] = None) -> Query:
