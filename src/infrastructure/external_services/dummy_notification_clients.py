...
class DummySMSClient(ISMSClient):
    ...
    async def send_sms(self, recipient_phone_number: str,
                       message: str) -> bool:
        self.logger.info(
...
class DummyInAppNotifier(IInAppNotifier):
    ...
    async def send_in_app_notification(
        self, recipient_user_id: str, message: str, metadata: Dict[str, Any]
    ) -> bool:
        self.logger.info(
...
class DummyPushNotifier(IPushNotifier):
    ...
    async def send_push_notification(
        self, device_token: str, title: str, body: str, metadata: Dict[str, Any]
    ) -> bool:
        self.logger.info(
