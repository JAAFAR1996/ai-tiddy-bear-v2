...
class StandardLogger:
    ...
    def performance_metric(self, message: str, duration_ms: float, **kwargs) -> None:
        ...
        context.update(kwargs)
        level = (
            LogLevel.WARNING if duration_ms > 2000 else LogLevel.INFO
        )  # 2s threshold for child attention
