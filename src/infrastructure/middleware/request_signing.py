...
class RequestSigningMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        logger.info(f"Request signing middleware initialized with {len(self.exempt_paths)} exempt paths")
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            if hasattr(request.state, "sign_response") and request.state.sign_response:
    ...
    async def _validate_request_signature(self, request: Request) -> Dict[str, Any]:
        """
    ...
    async def _sign_response(self, response: Response, request: Request) -> Response:
