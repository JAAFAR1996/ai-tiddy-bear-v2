        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Failed to log audit event for {func.__name__}: {audit_error}")
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Failed to schedule audit for {func.__name__}: {audit_error}")
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Failed to log data access audit for {func.__name__}: {audit_error}")
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Failed to schedule data access audit for {func.__name__}: {audit_error}")
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Failed to log security audit for {func.__name__}: {audit_error}")
...
def audit_login(extract_email: Optional[Callable] = None, extract_ip: Optional[Callable] = None):
    """Decorator for login operations."""
    return audit_authentication("login", extract_email, extract_ip)

def audit_logout(extract_email: Optional[Callable] = None, extract_ip: Optional[Callable] = None):
    """Decorator for logout operations."""
    return audit_authentication("logout", extract_email, extract_ip)

def audit_child_create(extract_child_id: Optional[Callable] = None, extract_user_id: Optional[Callable] = None):
    """Decorator for child creation operations."""
    return audit_data_access("create", "child_profile", extract_child_id, extract_user_id)

def audit_child_update(extract_child_id: Optional[Callable] = None, extract_user_id: Optional[Callable] = None):
    """Decorator for child update operations."""
    return audit_data_access("update", "child_profile", extract_child_id, extract_user_id)

def audit_child_delete(extract_child_id: Optional[Callable] = None, extract_user_id: Optional[Callable] = None):
    """Decorator for child deletion operations."""
    return audit_data_access("delete", "child_profile", extract_child_id, extract_user_id)