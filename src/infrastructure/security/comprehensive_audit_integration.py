...
class ComprehensiveAuditIntegration:
    ...
    async def log_coppa_compliance_event(
        ...
        audit_event_type = coppa_event_mapping.get(event_type, AuditEventType.PARENTAL_CONSENT_REQUEST)
    ...
    async def log_system_event(
        ...
        audit_event_type = system_event_mapping.get(event_type, AuditEventType.SYSTEM_STARTUP)
