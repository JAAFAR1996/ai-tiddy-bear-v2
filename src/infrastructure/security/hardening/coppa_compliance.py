...
class COPPACompliance:
    ...
    async def validate_parental_consent(
        self, consent_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            missing_fields = [
                field for field in required_fields if field not in consent_data
            ]
            if missing_fields:
                return {
                    "valid": False,
