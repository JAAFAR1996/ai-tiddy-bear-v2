...
from src.infrastructure.security.log_sanitization_config import (
    ...
    create_child_safe_log_sanitization_config,
...
class SecureLogger:
    ...
    def __init__(self, logger: logging.Logger, config: Optional[LogSanitizationConfig]=None):
        self.logger = logger
...
def get_secure_logger(
    name: str, config: Optional[LogSanitizationConfig] = None
) -> SecureLogger:
