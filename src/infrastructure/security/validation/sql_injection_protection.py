...
from src.infrastructure.validators.security.query_validator import QueryValidationResult
...
try:
    from src.infrastructure.security.validation.sanitizer import get_input_sanitizer
except ImportError:
...
try:
    from src.infrastructure.validators.security.query_validator import get_query_validator
except ImportError:
