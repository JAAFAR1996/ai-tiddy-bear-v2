...
class ServiceFactory:
    ...
    def create_speech_processor(self, settings: Any) -> Any:
        ...
        try:
            ...
            raise ImportError(
                f"Missing speech processor dependency: whisper") from e
            ...
            raise RuntimeError(
                f"Speech processor service creation failed") from e
    ...
    def create_openai_client(self, settings: Any) -> Any:
        ...
        try:
            ...
            if not hasattr(
                    settings, "OPENAI_API_KEY") or not settings.OPENAI_API_KEY:
    ...
    def create_tts_service(self, settings: Any) -> Any:
        ...
        try:
            ...
            raise ValueError(
                f"ELEVENLABS_API_KEY configuration required") from e
        except Exception as e:
            logger.critical(
    ...
    def create_database(self, settings: Any) -> Any:
        ...
        try:
            ...
            if not hasattr(
                    settings, "database") or not settings.database.DATABASE_URL:
                raise ValueError(
