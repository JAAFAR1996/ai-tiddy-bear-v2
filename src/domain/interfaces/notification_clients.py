...
class IInAppNotifier(ABC):
    ...
    """
    @abstractmethod
    async def send_in_app_notification(self, recipient_user_id: str, message: str, metadata: dict) -> bool: ...
...
class IPushNotifier(ABC):
    ...
    """
    @abstractmethod
    async def send_push_notification(self, device_token: str, title: str, body: str, metadata: dict) -> bool: ... 