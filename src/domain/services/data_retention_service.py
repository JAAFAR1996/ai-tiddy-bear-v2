...
class COPPADataRetentionService:
    ...
    def _initialize_retention_policies(self,) -> Dict[str, Dict[DataType, RetentionPolicy]]:
        ...
        policies = {
            ...
            "valid_child": {
                ...
                DataType.AUDIT_LOGS: RetentionPolicy(
                    DataType.AUDIT_LOGS, 2555, "valid_child", False, False  # 7 years
                ),
                DataType.PROFILE_DATA: RetentionPolicy(
                    DataType.PROFILE_DATA, 90, "valid_child", True, True
                ),
            },
            # Teens 13-17 (Modified requirements)
            "valid_teen": {
                DataType.CONVERSATION_DATA: RetentionPolicy(
                    DataType.CONVERSATION_DATA, 90, "valid_teen", True, True
                ),
                DataType.VOICE_RECORDINGS: RetentionPolicy(
                    DataType.VOICE_RECORDINGS, 30, "valid_teen", True, True
                ),
                DataType.INTERACTION_LOGS: RetentionPolicy(
                    DataType.INTERACTION_LOGS, 180, "valid_teen", True, True
                ),
                DataType.ANALYTICS_DATA: RetentionPolicy(
                    DataType.ANALYTICS_DATA, 365, "valid_teen", True, True
                ),
                DataType.SAFETY_LOGS: RetentionPolicy(
                    DataType.SAFETY_LOGS, 730, "valid_teen", False, True  # 2 years
                ),
                DataType.CONSENT_RECORDS: RetentionPolicy(
                    DataType.CONSENT_RECORDS,
                    2555,
                ...
                DataType.AUDIT_LOGS: RetentionPolicy(
                    DataType.AUDIT_LOGS, 2555, "valid_teen", False, False  # 7 years
                ),
                DataType.PROFILE_DATA: RetentionPolicy(
                    DataType.PROFILE_DATA, 365, "valid_teen", True, True
                ),
            },
            # Adults 18+ (Standard requirements)
            "valid_adult": {
                DataType.CONVERSATION_DATA: RetentionPolicy(
                    DataType.CONVERSATION_DATA, 365, "valid_adult", True, False
                ),
                DataType.VOICE_RECORDINGS: RetentionPolicy(
                    DataType.VOICE_RECORDINGS, 90, "valid_adult", True, False
                ),
                DataType.INTERACTION_LOGS: RetentionPolicy(
                    DataType.INTERACTION_LOGS, 365, "valid_adult", True, False
                ),
                DataType.ANALYTICS_DATA: RetentionPolicy(
                    DataType.ANALYTICS_DATA, 730, "valid_adult", True, False  # 2 years
                ),
                DataType.SAFETY_LOGS: RetentionPolicy(
                    DataType.SAFETY_LOGS, 1095, "valid_adult", False, False  # 3 years
                ),
                DataType.CONSENT_RECORDS: RetentionPolicy(
                    DataType.CONSENT_RECORDS,
                    2555,
                ...
                DataType.AUDIT_LOGS: RetentionPolicy(
                    DataType.AUDIT_LOGS, 2555, "valid_adult", False, False  # 7 years
                ),
                DataType.PROFILE_DATA: RetentionPolicy(
                    DataType.PROFILE_DATA, 1095, "valid_adult", True, False  # 3 years
                ),
            },
        }
        return policies
    ...
    def calculate_deletion_date(
        self, child_age: int, data_type: DataType, created_at: datetime
    ) -> datetime:
        """
    ...
    def validate_retention_compliance(self, child_age: int) -> Dict[str, Any]:
        ...
        if is_coppa_applicable:
            conversation_policy = self.get_retention_policy(
                child_age, DataType.CONVERSATION_DATA
            )
            voice_policy = self.get_retention_policy(
                child_age, DataType.VOICE_RECORDINGS
            )
