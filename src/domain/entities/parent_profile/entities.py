...
class Parent:
    ...
    def update_preference(self, key: str, value: Any) -> None:
        ...
        elif key == "child_safety_level" and value not in ["strict", "moderate", "relaxed"]:
            raise ValueError("Invalid safety level")
        elif key == "session_timeout_minutes" and (not isinstance(value, int) or value < 5 or value > 480):
    ...
    def __repr__(self) -> str:
        ...
        return (f"Parent(id='{self.id}', name='{self.get_full_name()}', "
