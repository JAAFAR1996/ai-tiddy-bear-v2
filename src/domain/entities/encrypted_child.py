...
class EncryptedChild:
    ...
    def set_emergency_contacts(self, contacts: List[Dict[str, Any]], encryption_key: bytes) -> None:
        """
        ...
        """
        self._encrypted_emergency_contacts = EncryptedField.from_data(contacts, encryption_key)
        self.updated_at = datetime.utcnow()

    def get_emergency_contacts(self, encryption_key: bytes) -> Optional[List[Dict[str, Any]]]:
        """
