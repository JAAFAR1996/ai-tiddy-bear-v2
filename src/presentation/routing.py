...
from src.common.constants import (
    API_PREFIX_ESP32, API_TAG_ESP32,
    API_PREFIX_DASHBOARD, API_TAG_DASHBOARD,
    API_PREFIX_HEALTH, API_TAG_HEALTH,
    API_PREFIX_CHATGPT, API_TAG_CHATGPT,
    API_PREFIX_AUTH, API_TAG_AUTH
...
def setup_routing(app: FastAPI) -> None:
    ...
    router_configs = [
        ...
        (parental_router, API_PREFIX_DASHBOARD, API_TAG_DASHBOARD, "Dashboard"),
