...
class SystemMonitorService:
    ...
    async def check_system_health(self) -> List[SystemStatus]:
        ...
        async with httpx.AsyncClient() as client:
            tasks = [self._check_service_health(client, service) for service in self.services]
    ...
    async def _check_service_health(self, client: httpx.AsyncClient, service: str) -> SystemStatus:
        """فحص صحة خدمة واحدة"""
