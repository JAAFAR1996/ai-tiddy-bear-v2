...
class ChildOperations:
    ...
    def __init__(
        ...
        coppa_compliance_service: ProductionCOPPACompliance=Depends(Provide[container.coppa_compliance_service]),
        pagination_service: PaginationService=Depends(Provide[container.pagination_service]),
    ) -> None:
    ...
    async def create_child(self, request: ChildCreateRequest, parent_id: str) -> ChildResponse:
    ...
    async def get_children(
        self, parent_id: str, pagination_request: Optional[PaginationRequest] = None
        ...
        try:
            ...
            return self.pagination_service.paginate_list(
                child_responses, safe_pagination
            )
        except Exception as e:
    ...
    async def update_child(
        self, child_id: str, request: ChildUpdateRequest
    ) -> ChildResponse:
...
class ChildValidationService:
    ...
    def validate_child_creation(
        self, request: ChildCreateRequest, parent_id: str
    ) -> None:
