...
from src.infrastructure.config.coppa_config import is_coppa_enabled, should_show_coppa_notices
...
async def request_data_deletion(
    ...
    try:
        deletion_result = await handle_compliant_child_deletion(child_id, current_user.id)
