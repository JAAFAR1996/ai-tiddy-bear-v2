...
class MonitoringDashboardService:
    ...
    async def get_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "system_status": "operational" if health_status["score"] > 0.8 else "degraded"
            }
    ...
    async def get_metrics_dashboard(self, time_range: str = "1h") -> Dict[str, Any]:
        ...
        try:
            ...
            # Get metrics data
            dashboard_metrics = {}
            for metric_name, metric_values in monitoring_service.metrics.items():
                recent_values = [
    ...
    async def get_child_safety_dashboard(self) -> Dict[str, Any]:
        ...
        try:
            ...
            active_safety_alerts = [
                alert for alert in safety_monitor.safety_alerts.values()
    ...
    async def get_security_dashboard(self) -> Dict[str, Any]:
        ...
        try:
            ...
            threat_level = self._calculate_threat_level(security_counts, failed_auth_summary)
    ...
    async def get_coppa_compliance_dashboard(self) -> Dict[str, Any]:
        ...
        try:
            ...
            compliance_score = self._calculate_compliance_score(coppa_counts, consent_violations)
            ...
            return {
                ...
                "compliance_status": "compliant" if compliance_score > 0.9 else "needs_attention",
                "last_updated": datetime.utcnow().isoformat()
            }
        except Exception as e:
    ...
    def _calculate_health_status(self, metrics_summary: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _get_recent_alerts(self, hours: int = 24) -> List[Dict[str, Any]]:
        ...
        for alert in monitoring_service.alerts.values():
            if (alert.last_triggered and
                alert.last_triggered > cutoff_time and
    ...
    def _get_child_safety_summary(self) -> Dict[str, Any]:
        ...
        recent_events = [
            event for event in safety_monitor.safety_events
    ...
    def _calculate_threat_level(self, security_counts: Dict[str, int],
                              failed_auth: Dict[str, int]) -> str:
    ...
    def _calculate_compliance_score(self, coppa_counts: Dict[str, int],
...
if FASTAPI_AVAILABLE:
    ...
    async def get_metrics_dashboard(
        time_range: str = Query("1h", regex="^(1h|6h|12h|24h|7d|30d)$",
    ...
    async def get_active_alerts(
        severity: Optional[str] = Query(None, regex="^(low|medium|high|critical|emergency)$",
        ...
        try:
            ...
            return {
                "alerts": sorted(active_alerts, key=lambda x: x["severity"], reverse=True),
