...
from .header_config import SecurityHeadersConfig, CSPConfig
...
class SecurityHeadersBuilder:
    ...
    def _build_dynamic_headers(self, request: Request) -> Dict[str, str]:
        ...
        if hasattr(request.state, "start_time"):
            import time
            processing_time = int((time.time() - request.state.start_time) * 1000)
...
def create_headers_builder(environment: str = "production") -> SecurityHeadersBuilder:
    """
