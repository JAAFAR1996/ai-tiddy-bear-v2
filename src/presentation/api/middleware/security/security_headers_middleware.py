...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    """
    def __init__(self, app, security_level: SecurityLevel = SecurityLevel.PRODUCTION) -> None:
        ...
        logger.info(f"Security headers middleware initialized for {security_level.value}")
    ...
    def _add_essential_headers(self, response: Response, request: Request) -> None:
    ...
    def _is_child_data_endpoint(self, response: Response) -> bool:
        ...
        return "child" in content_type.lower() or "X-Child-Data" in response.headers
...
def create_security_headers_middleware(security_level: str = "production") -> SecurityHeadersMiddleware:
    """
    ...
    try:
        ...
        logger.warning(f"Invalid security level '{security_level}', defaulting to production")
