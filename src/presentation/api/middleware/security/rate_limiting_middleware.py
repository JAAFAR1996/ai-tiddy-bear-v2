...
class RateLimitingMiddleware(BaseHTTPMiddleware):
    ...
    def _get_current_limit_status(self, client_ip: str, endpoint: str) -> Dict[str, Any]:
    ...
    def get_rate_limit_status(self, client_ip: str, endpoint: Optional[str] = None) -> Dict[str, Any]:
        """
