    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        try:
            ...
            def add_rate_limit_headers(response: Response) -> Response:
                response.headers["X-RateLimit-Limit"] = str(self._get_config_limit(config_name))
            ...
            if not result.allowed:
                ...
                error_response = self._create_rate_limit_error_response(result, config_name)
        ...
        try:
            ...
            if "children" in path_parts:
                ...
                if len(path_parts) > children_index + 1:
                    ...
                    if len(potential_id) > 10 and ("-" in potential_id or potential_id.isalnum()):
                        return potential_id
...
def create_rate_limit_middleware(
    app,
    default_config: str = "api_general",
    enable_child_safety: bool = True) -> RateLimitMiddleware:
