...
class ConsentVerificationRoute(APIRoute):
    ...
    async def _log_data_collection(self, request: Request, child_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"Data collection logged: {audit_entry.event_type} for child {child_id}")
        except Exception as e:
...
class ConsentVerificationMiddleware:
    ...
    """
    def __init__(self, app, consent_required_paths: Optional[Dict[str, list]] = None) -> None:
        self.app = app
