...
class MessageRequest(BaseModel):
    ...
    @validator("message")
    def validate_message_content(self, v) -> str:
...
class ChildRegistrationRequest(BaseModel):
    ...
    @validator("age")
    def validate_coppa_age(self, v) -> int:
    ...
    def validate_birth_date(self, v, values) -> datetime:
...
class AudioMessageRequest(BaseModel):
    ...
    def validate_audio_data(self, v) -> bytes:
...
class ParentConsentRequest(BaseModel):
    ...
    def validate_consent_type(self, v) -> str:
...
class PaginationRequest(BaseModel):
    ...
    @validator("limit")
    def validate_child_safe_limit(self, v) -> int:
...
class FileUploadRequest(BaseModel):
    ...
    @validator("filename")
    def validate_filename_safety(self, v) -> str:
    ...
    def validate_content_type(self, v) -> str:
